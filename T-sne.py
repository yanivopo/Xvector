...
plt.title("T-sne {} training, number of speaker {} , number of sample {}".format(train_str, number_of_speaker, sample_per_speaker))
plt.savefig('./pictures/t_sne_{}_speaker_{}_train'.format(number_of_speaker, train_str))
plt.figure()
...
plt.title("PCA {} training, number of speaker {}  explained_variance {:.2f} "
          .format(train_str, number_of_speaker, explained_variance))
plt.savefig('./pictures/PCA_{}_speaker_{}_train'.format(number_of_speaker, train_str))
plt.show()
